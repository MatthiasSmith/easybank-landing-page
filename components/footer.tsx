...
const Footer = () => {
  return (
    <footer className='pt-10 pb-6 px-6 bg-dark-blue flex flex-col'>
      <div className='max-w-screen-lg mx-auto w-full flex flex-col items-center md:flex-row'>
        ...
        <FooterNav />
        <div className='mt-8 flex flex-col items-center md:items-end md:mt-0'>
          <RequestInviteButton />
          <div className='mt-8 text-grayish-blue text-sm'>
            © Easybank. All Rights Reserved
          </div>
        </div>
      </div>
      <div className='mt-12 text-very-xs text-grayish-blue mx-auto'>
        Challenge by{' '}
        <a
